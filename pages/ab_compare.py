...
def run_ab_comparison(
    ...
    # [FIX 2026-09-23] Same bug as backtest_engine.run_backtest() (see that
    # commit): regime above is a single "as of now" scalar. Without this,
    # generate_signals_historical() (called below for both legacy/dispatch)
    # would gate a 2024 trade by today's regime. _nifty_regime_series lets
    # it gate each bar by ITS OWN date's regime instead.
    base_settings["_nifty_regime_series"] = nifty_regime_series(nifty)
