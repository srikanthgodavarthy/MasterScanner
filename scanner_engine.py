...
NIFTY500_SYMBOLS = [
    ...
    # Nifty Next 50
    "AMBUJACEM","DLF","GODREJPROP","ETERNAL","COCHINSHIP","CESC","BIOCON",
    "HFCL","NTPCGREEN","BEML","SCI","CENTRALBANK",
    "ADANIGREEN","ADANIPOWER","ATGL","AWL","ABCAPITAL","ABFRL","ACC","AIAENG",
    "ALKEM","APLLTD","APLAPOLLO","APOLLOHOSP","APOLLOTYRE","ATUL","AUBANK",
    "AUROPHARMA","BALKRISIND","BANKINDIA","BATAINDIA","BERGEPAINT","BHARATFORG",
    "BHEL","BOSCHLTD","CANBK","CHOLAFIN","COLPAL","CONCOR","CROMPTON",
    "CUMMINSIND","DABUR","DEEPAKNTR","DELTACORP","DIXON","DMART","ESCORTS",
    "EXIDEIND","FEDERALBNK","FSL","GAIL","GMRAIRPORT","GNFC","GODREJCP",
    "GRANULES","GUJGASLTD","HAVELLS","HINDPETRO","HONAUT","IDFCFIRSTB",
    "IEX","IPCALAB","IRB","IRCTC","JINDALSTEL","JUBLFOOD","JUBILANT",
    "KAJARIACER","KEC","KPITTECH","LALPATHLAB","LAURUSLABS","LICHSGFIN",
    "LUPIN","MANAPPURAM","MARICO","MCDOWELL-N","MFSL","MOTHERSON","MPHASIS",
    "MRF","MUTHOOTFIN","NAVINFLUOR","NMDC","OBEROIRLTY","OFSS","PAGEIND",
    "PEL","PERSISTENT","PETRONET","PFC","PIDILITIND","PNB","POLYCAB",
    "PVRINOX","RAMCOCEM","RECLTD","SAIL","SBICARD","SCHAEFFLER","SIEMENS",
    "SJVN","SKFINDIA","STAR","SUNDARMFIN","SUPREMEIND","SYNGENE","TATACOMM",
    "TATACONSUM","TATAELXSI","TATAPOWER","TORNTPHARM","TORNTPOWER","TRENT",
    "TRIDENT","TVSMOTOR","UBL","UNIONBANK","UNITDSPR","VEDL","VOLTAS",
